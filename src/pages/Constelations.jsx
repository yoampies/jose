    ...
    <section className="bg-gray-100">
      ...
      <div className="bg-[#FFC95E] py-12 px-6 md:px-20 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-1/2 mt-6 md:mt-0 flex justify-center">
          <img src={home_therapy} alt="Constelaciones familiares" className="rounded-full" />
        </div>
      </div>
      ...
      <div className="bg-blue-800 py-12 px-6 text-white px-20">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-600 p-6 rounded-lg text-center">
            <img src={home_therapy} alt="Problemas de Relación" className="rounded-full pt-2 pb-6" />
          ...
          <div className="bg-blue-600 p-6 rounded-lg text-center">
            <img src={home_therapy} alt="Problemas de Salud" className="rounded-full pt-2 pb-6" />
          ...
          <div className="bg-blue-600 p-6 rounded-lg text-center">
            <img src={home_therapy} alt="Problemas de Económicos" className="rounded-full pt-2 pb-6" />
