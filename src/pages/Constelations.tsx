  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (circle3Ref.current) {
        gsap.fromTo(circle3Ref.current, 
          { x: 1000, y: -500, scale: 0, opacity: 0 }, 
          { x: 0, y: 0, scale: 1, opacity: 1, duration: 1.5, ease: "power3.out", scrollTrigger: {
      ...
      if (circle4Ref.current) {
        gsap.fromTo(circle4Ref.current, 
          { x: -1000, y: 500, scale: 0, opacity: 0 }, 
          { x: 0, y: 0, scale: 1, opacity: 1, duration: 1.5, ease: "power3.out", scrollTrigger: {
      ...
      const helpCards = [help1Ref.current, help2Ref.current, help3Ref.current].filter(el => el !== null);
      if (helpCards.length > 0) {
        gsap.fromTo(helpCards, 
          { y: 50, opacity: 0 }, 
  ...
  return (
    <section className="bg-gray-100">
      ...
      <div className="relative h-screen w-full bg-cover bg-center flex flex-col justify-center items-center text-white text-center px-4 overflow-hidden">
        <img src={constelations} className='absolute inset-0 w-full h-full object-cover z-0' alt="Hero Background"/>
        <div className="z-10">
        ...
        <div className="relative z-20">
          ...
          <p className="text-lg font-semibold italic py-4">
            Explora tus raíces familiares, sana las heridas que te impiden avanzar y 
            <br />libera el potencial que reside en ti para vivir una vida plena y feliz.
          </p>
      ...
      <div className="bg-[#FFC95E] md:px-20 py-12 flex flex-col md:flex-row items-center gap-8 overflow-hidden">
        ...
        <div className="w-full md:w-1/2 mt-6 md:mt-0 flex justify-center" ref={cirImgRef}>
          <img src={constelations_wi} alt="Constelaciones familiares descripción" className="rounded-full object-cover w-96 h-96 my-6" />
        </div>
      </div>
        ...
        <div className='relative z-20'>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-blue-600 p-6 rounded-lg text-center" ref={help1Ref}>
              <img src={constelations_relationship} alt="Icono Problemas de Relación" className="rounded-full pt-2 pb-6 h-48 w-48 mx-auto" />
            ...
            <div className="bg-blue-600 p-6 rounded-lg text-center" ref={help2Ref}>
              <img src={constelations_health} alt="Icono Problemas de Salud" className="rounded-full pt-2 pb-6 h-48 w-48 mx-auto" />
            ...
            <div className="bg-blue-600 p-6 rounded-lg text-center" ref={help3Ref}>
              <img src={constelations_money} alt="Icono Problemas Económicos" className="rounded-full pt-2 pb-6 h-48 w-48 mx-auto" />
      ...
      <div className="bg-[#823B76] px-6 md:px-20 py-12 flex flex-col md:flex-row items-center gap-x-8 overflow-hidden">
        <div className="w-full md:w-1/2 md:mt-0 flex justify-center" ref={imgRef}>
          <img src={constelations_portrait} alt="Representación de Constelaciones" className="px-16 py-10" />
        </div>
        <div className="w-full md:w-1/2" ref={text2Ref}>
          <h2 className="text-2xl font-bold text-white">¿Cómo funcionan las constelaciones?</h2>
