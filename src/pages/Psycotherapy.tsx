...
const Psycotherapy = () => {
  ...
  useEffect (() => {
          ...
          gsap.fromTo(cir1, {x: -1000, opacity: 0}, {x: 0, opacity: 0.6, duration: 1.5})

          const cir2 = circle2Ref.current;
          gsap.fromTo(cir2, {y: -1000, opacity: 0}, {y: 0, opacity: 0.6, duration: 1.5})

          const cir3 = circle3Ref.current;
          gsap.fromTo(cir3, {x: 1000, opacity: 0}, {x: 0, opacity: 0.6, duration: 1.5})
