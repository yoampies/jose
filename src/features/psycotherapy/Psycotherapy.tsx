    ...
    <section className="bg-gray-100">
        ...
        >
          <div className="text-center grid justify-items-center absolute z-10">
            ...
            <p className="mt-2 px-8">
              ...
              un profesional de la salud mental. A través de la conversación,
              aprenderás a identificar y comprender las causas de tus
              dificultades, desarrollarás herramientas para manejar situaciones
              difíciles y lograrás una mayor bienestar emocional. ¿Estás listo
              para comenzar tu viaje hacia el bienestar?
            </p>
          </div>
        ...
        <div className="relative z-20">
          ...
          >
            {services.map((service: IService, index: number) => (
              <div
                key={index}
                className="bg-yellow-400 p-2 rounded-lg flex flex-col items-center"
              >
                <img
                  src={service.img}
                  alt={service.title}
      ...
      <div className="bg-green-400 py-10 px-6 text-center overflow-hidden">
        ...
        >
          ...
          />
          <textarea
            placeholder="¿Cuál es la razón de tu consulta?"
            className="w-full p-2 mb-4 rounded-lg text-black"
            rows={4}
          ></textarea>
