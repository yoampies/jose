...
const Constelations: React.FC = () => {
  ...
  const cirImgRef = useRef<HTMLDivElement>(null);
  const textRef = useRef<HTMLDivElement>(null);
  const circle3Ref = useRef<HTMLDivElement>(null);
  const circle4Ref = useRef<HTMLDivElement>(null);
  const help1Ref = useRef<HTMLDivElement>(null);
  const help2Ref = useRef<HTMLDivElement>(null);
  const help3Ref = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (circle3Ref.current) {
        gsap.fromTo(
          circle3Ref.current,
          { x: 1000, y: -500, scale: 0, opacity: 0 },
          {
            x: 0,
            y: 0,
            scale: 1,
  ...
  return (
    <section className="bg-gray-100">
      <Navbar />
      <div className="relative h-screen w-full bg-cover bg-center flex flex-col justify-center items-center text-white text-center px-4 overflow-hidden">
        <img
          src={constelations}
        ...
        <div className="relative z-20">
          ...
          <p className="text-lg font-semibold italic py-4">
            Explora tus raíces familiares, sana las heridas que te impiden
            avanzar y
            <br />
            libera el potencial que reside en ti para vivir una vida plena y
            feliz.
          </p>
          <button className="mt-4 bg-blue-600 px-6 py-2 rounded-lg text-white font-semibold hover:bg-blue-700">
            Aprende más
          </button>
        </div>
      </div>
      ...
      <div className="bg-[#FFC95E] md:px-20 py-12 flex flex-col md:flex-row items-center gap-8 overflow-hidden">
        <div className="w-full md:w-1/2" ref={textRef}>
          ...
          <p className="mt-4 text-lg text-blue-900">
            Las constelaciones familiares son una herramienta terapéutica que te
            invita a explorar las dinámicas ocultas de tu sistema familiar.{" "}
            <br />
            Es un espacio donde podrás observar las fuerzas que influyen en tus
            relaciones, tus emociones y tus patrones de comportamiento. <br />A
            través de la representación de tu árbol genealógico, podrás
            comprender las lealtades invisibles, los traumas no resueltos y los
            conflictos que te impiden avanzar.
          </p>
        </div>
        <div
        ...
        >
          <img
            ...
            alt="Constelaciones familiares descripción"
      ...
      <div className="bg-blue-800 py-10 text-white px-20 relative overflow-hidden">
        <div className="relative z-20">
          <h2 className="text-2xl font-bold text-center">
            ¿Cómo te pueden ayudar las constelaciones?
          </h2>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <img
                src={constelations_relationship}
                alt="Icono Problemas de Relación"
                className="rounded-full pt-2 pb-6 h-48 w-48 mx-auto"
              />
              <h3 className="text-xl font-semibold">Problemas de relación</h3>
              <p className="mt-2">
                Con tus parejas, padres, hermanos o hijos. Encuentra los
                patrones que las rigen.
              </p>
            </div>
            <div
              className="bg-blue-600 p-6 rounded-lg text-center"
            ...
            >
              <img
                src={constelations_health}
                alt="Icono Problemas de Salud"
                className="rounded-full pt-2 pb-6 h-48 w-48 mx-auto"
              />
              <h3 className="text-xl font-semibold">Problemas de salud</h3>
              <p className="mt-2">
                Aunque no curan enfermedades, pueden ayudar a comprender el
                origen emocional.
              </p>
            </div>
            <div
            ...
            >
              <img
                src={constelations_money}
                alt="Icono Problemas Económicos"
                className="rounded-full pt-2 pb-6 h-48 w-48 mx-auto"
              />
              <h3 className="text-xl font-semibold">Problemas económicos</h3>
              <p className="mt-2">
                Dificultades para administrar el dinero, deudas, sensación de
                escasez, etc.
              </p>
            </div>
          </div>
      ...
      <div className="bg-[#823B76] px-6 md:px-20 py-12 flex flex-col md:flex-row items-center gap-x-8 overflow-hidden">
        ...
        >
          <img
            ...
            alt="Representación de Constelaciones"
        ...
        <div className="w-full md:w-1/2" ref={text2Ref}>
          ...
          <p className="mt-4 text-lg text-white">
            El proceso implica definir un tema, seleccionar representantes,
            colocarlos en el espacio según la intuición del consultante,
            desarrollar la constelación a través de las emociones expresadas por
            los representantes, y buscar una resolución en la que todos
            encuentren su lugar. <br />
            Esta técnica revela lealtades invisibles, exclusiones y traumas
            transgeneracionales, y puede aportar comprensión, liberación
            emocional, resolución de conflictos y crecimiento personal.
          </p>
        </div>
      </div>
